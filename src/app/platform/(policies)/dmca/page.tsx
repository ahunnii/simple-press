...
export default function DmcaPage() {
  return (
    <div className="prose prose-lg mx-auto w-full max-w-7xl px-4 py-8">
      ...
      <p>
        THE CENTER FOR GENERATIVE JUSTICE LLC (&ldquo;SimplePress,&rdquo; &ldquo;we,&rdquo;
        &ldquo;us,&rdquo; or &ldquo;our&rdquo;) respects the intellectual property rights
        of others and expects users of the SimplePress platform to do the same.
      </p>
      <p>
        This Digital Millennium Copyright Act (&ldquo;DMCA&rdquo;) Policy explains how
        copyright owners may report allegedly infringing content hosted on the SimplePress
        platform and how we respond to such reports.
      </p>
      ...
      <ul>
        ...
        <li>user-uploaded content hosted through SimplePress infrastructure.</li>
      </ul>
      <hr />

      <h2>2. Reporting Copyright Infringement</h2>
      <p>
        If you believe that content hosted on SimplePress infringes your copyright, you may
        submit a written DMCA takedown notice to our designated DMCA contact.
      </p>
      ...
      <p>
        We reserve the right to remove content that appears to infringe intellectual
        property rights even in cases where a formal DMCA notice has not been submitted.
      </p>
      <hr />

      <h2>4. Counter-Notifications</h2>
      <p>
        If you believe your content was removed or disabled in error, you may submit a
      ...
      <ol>
        ...
        <li>
          A statement consenting to the jurisdiction of the federal court located in
          Michigan;
        </li>
        <li>Your physical or electronic signature.</li>
      </ol>
      ...
      <p>
        If we receive a valid counter-notification, we may restore the removed content
        unless the original complainant files a court action within the time period required
        by applicable law.
      </p>
      <hr />
      ...
      <p>
        SimplePress reserves the right to suspend or terminate accounts, storefronts,
        domains, or platform access for users or businesses that repeatedly infringe
        intellectual property rights.
      </p>
      <p>
        We may also restrict future access to users previously removed for repeated
        infringement.
      </p>
      <hr />
      ...
      <p>
        Submitting knowingly false or misleading DMCA notices or counter-notifications may
        result in legal liability.
      </p>
      <p>
        Users should ensure that all notices are submitted in good faith and with proper
        authority.
      </p>
      <hr />
      ...
      <p>
        SimplePress is a software and infrastructure platform that allows independent
        businesses to host storefronts and upload content.
      </p>
      <p>
        SimplePress does not pre-screen all uploaded material and does not independently
        verify ownership or licensing rights for user-submitted content.
      </p>
      <p>
        Users and businesses remain solely responsible for the content they upload, publish,
      ...
      <ul>
        ...
        <li>
          take any action necessary to protect the platform and intellectual property
          rights.
        </li>
      </ul>
      <hr />
      ...
      <p>
        We may update or modify this DMCA Policy at any time as the platform evolves.
      </p>
