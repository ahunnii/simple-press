                            ...
                            <div className="flex items-center gap-3">
                              {event.coverImage ? (
                                <div className="bg-muted relative h-10 w-10 shrink-0 overflow-hidden rounded">
                                  {/* eslint-disable-next-line @next/next/no-img-element -- cover images are arbitrary S3 URLs rendered at a fixed 40px; next/image's loader machinery buys nothing at this size and adds a remote-pattern config burden. */}
                                  <img
