...
import { QUOTE_QUESTION_TYPE_VALUES } from "~/lib/validators/quote-calculator";
 ...
 * and all seven settings) is optional on the input side, which is exactly what
...
export type QuestionInput = CalculatorDefinitionInput["questions"][number];
