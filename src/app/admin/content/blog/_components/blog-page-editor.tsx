...
type BlogEditorTab = "content" | "seo";
...
const tabForField = (name: string): BlogEditorTab =>
...
export function BlogPostEditor({
  ...
  const [activeTab, setActiveTab] = useState<BlogEditorTab>("content");
  ...
  /**
   * The slug tracks the title only while the post has never been live. There is
   * no redirect infrastructure, so once a URL has been public — or has been
   ...
   * setting a schedule freezes the slug immediately, because the cron will flip
   * the post live without anyone reopening this editor. Clearing the schedule
   * field unfreezes it again — nothing is committed at that point.
   */
  const slugAutoSyncs = (
    livePublished: boolean,
    liveScheduledAt: string | null | undefined,
  ) => !page || (!page.published && !livePublished && !liveScheduledAt);
  ...
  const handleTitleChange = (value: string) => {
    ...
    if (
      !slugAutoSyncs(
        ...
        form.getValues("scheduledPublishAt"),
      )
    ) {
      return;
    }
  ...
  const slugFrozen = !slugAutoSyncs(
  ...
  const seoPreviewDesc =
    ...
    form.watch("excerpt") ||
    "Your post description will appear here in search results.";
                      ...
                      <div className="flex gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2.5 text-sm text-amber-800">
                        ...
                        <div className="space-y-0.5">
                          ...
                          <p className="text-amber-700">
                            ...
                            post. We don&apos;t create a redirect automatically.
                          </p>
                          <Button
                            type="button"
                            variant="outline"
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <p className="text-muted-foreground text-xs">
                              {field.value
                                ? `Scheduled for ${new Date(field.value).toLocaleString()} — the URL is locked from here on, so it won't follow further title edits.`
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-4">
                        <InputFormField
                          ...
                          name="slug"
                          label="URL Slug"
                          placeholder="how-we-got-started"
                          onChange={(value) => {
                            slugManuallyEditedRef.current = true;
                          ...
                          required
                          description={`Used in the post URL: /blog/${watchedSlug || "your-post"}`}
                        ...
                        {page?.id && watchedSlug !== page.slug && (
                          <div className="flex gap-2 rounded-lg border border-amber-200 bg-amber-50 px-3 py-2.5 text-sm text-amber-800">
                            ...
                            <div className="space-y-0.5">
                              <p className="font-medium">
                                Heads up — this will change the post&apos;s URL.
                              </p>
                              <p className="text-amber-700">
                        ...
                        <TextareaFormField
                          ...
                          placeholder="All About a Thing: A detailed description of the post..."
                          description={
                            <span
                              className={
                            ...
                            >
                              ...
                              blank to use the post description
                            </span>
                          }
                          descriptionClassName="text-xs text-muted-foreground"
                          rows={3}
                  ...
                  <div className="space-y-6">
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          How this post might appear in Google
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <SearchResultPreview
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          How this post looks when shared on social platforms
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <SocialPreviewCard
