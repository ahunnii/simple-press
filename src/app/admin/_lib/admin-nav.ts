...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    keywords: ["tips", "support", "donate", "fundraiser"],
  },
...
export const HUB_CARDS: HubCard[] = [
  ...
  {
    key: "settings-donations",
    title: "Donations",
    description: "Label, presets, Venmo, Cash App",
    body: "Configure how customers can donate or tip via Stripe, Venmo, or Cash App",
