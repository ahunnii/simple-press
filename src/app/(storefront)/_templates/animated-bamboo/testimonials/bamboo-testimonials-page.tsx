...
export async function BambooTestimonialsPage({
  ...
  const f = resolveFields(business?.siteContent?.customFields, [
    "animated-bamboo.testimonials-page.heading",
    "animated-bamboo.testimonials-page.subheading",
  ]);

  const heading = f["animated-bamboo.testimonials-page.heading"] ?? "";
  const subheading = f["animated-bamboo.testimonials-page.subheading"] ?? "";
      ...
      >
        ...
        <div className="relative mx-auto w-full max-w-[1200px] px-6">
          <h1
            ...
            {...fieldAttr("animated-bamboo.testimonials-page.heading")}
          >
            {heading}
          </h1>
          {subheading ? (
            <p
              ...
              {...fieldAttr("animated-bamboo.testimonials-page.subheading")}
            >
              {subheading}
            </p>
          ) : null}
