...
/// survives. `animated-bamboo.about.hero-tagline` is DROPPED (see aboutHeroData below) —
...
const aboutHeroData: TemplateField[] = [
  {
    key: "animated-bamboo.about.hero-heading",
  ...
  {
    key: "animated-bamboo.about.hero-intro",
  ...
  {
    key: "animated-bamboo.about.hero-image",
...
const aboutMissionData: TemplateField[] = [
  {
    key: "animated-bamboo.about.mission-heading",
  ...
  {
    key: "animated-bamboo.about.mission-image",
  ...
  {
    key: "animated-bamboo.about.mission-paragraph",
...
const aboutDetroitData: TemplateField[] = [
  {
    key: "animated-bamboo.about.detroit-heading",
  ...
  {
    key: "animated-bamboo.about.detroit-body",
...
const aboutValuesData: TemplateField[] = [
  {
    key: "animated-bamboo.about.values-heading",
  ...
  {
    key: "animated-bamboo.about.values-list",
    label: "Values List",
    description:
...
const aboutWhyBambooData: TemplateField[] = [
  {
    key: "animated-bamboo.about.why-bamboo-heading",
  ...
  {
    key: "animated-bamboo.about.why-bamboo-intro",
  ...
  {
    key: "animated-bamboo.about.why-bamboo-facts-list",
...
const aboutSupplierData: TemplateField[] = [
  {
    key: "animated-bamboo.about.supplier-heading",
  ...
  {
    key: "animated-bamboo.about.supplier-text",
    label: "Supplier Text",
...
We operate with the ethos of respecting every customer, valuing the relationships we build, and contributing to the collective well-being of the communities we serve. Located in the heart of Detroit, we extend our warmest welcome to you -- every customer is a member of our extended family.`,
  ...
  {
    key: "animated-bamboo.about.supplier-image",
...
const aboutLabelData: TemplateField[] = [
  {
    key: "animated-bamboo.about.label-heading",
  ...
  {
    key: "animated-bamboo.about.label-body",
  ...
  {
    key: "animated-bamboo.about.label-image",
    label: "Label Photo",
    description:
...
const aboutNationwideData: TemplateField[] = [
  {
    key: "animated-bamboo.about.nationwide-heading",
  ...
  {
    key: "animated-bamboo.about.nationwide-text",
  ...
  {
    key: "animated-bamboo.about.nationwide-image",
  ...
  {
    key: "animated-bamboo.about.nationwide-facts-list",
...
const aboutCTAData: TemplateField[] = [
  {
    key: "animated-bamboo.about.cta-heading",
    label: "CTA Heading",
  ...
  {
    key: "animated-bamboo.about.cta-text",
    label: "CTA Text",
  ...
  {
    key: "animated-bamboo.about.cta-button-text",
  ...
  {
    key: "animated-bamboo.about.cta-button-link",
  ...
  {
    key: "animated-bamboo.about.cta-secondary-button-text",
  ...
  {
    key: "animated-bamboo.about.cta-secondary-button-link",
...
export const DEFAULT_ANIMATED_BAMBOO_VALUES: GenericIconRow[] = [
  {
    icon: Leaf,
...
export const DEFAULT_ANIMATED_BAMBOO_NATIONWIDE_FACTS: GenericIconRow[] = [
  {
    icon: Truck,
...
export const DEFAULT_ANIMATED_BAMBOO_WHY_BAMBOO_FACTS: GenericIconRow[] = [
  {
    icon: Sprout,
