...
import {
  DEFAULT_ANIMATED_BAMBOO_NATIONWIDE_FACTS,
  DEFAULT_ANIMATED_BAMBOO_VALUES,
...
export function BambooAboutPage({ business }: DefaultAboutPageTemplateProps) {
  ...
  const f = resolveFields(customFields, [
    "animated-bamboo.about.hero-heading",
    "animated-bamboo.about.hero-intro",
    "animated-bamboo.about.hero-image",
    "animated-bamboo.about.mission-heading",
    "animated-bamboo.about.mission-image",
    "animated-bamboo.about.mission-paragraph",
    "animated-bamboo.about.detroit-heading",
    "animated-bamboo.about.detroit-body",
    "animated-bamboo.about.values-heading",
    "animated-bamboo.about.why-bamboo-heading",
    "animated-bamboo.about.why-bamboo-intro",
    "animated-bamboo.about.supplier-heading",
    "animated-bamboo.about.supplier-text",
    "animated-bamboo.about.label-heading",
    "animated-bamboo.about.label-body",
    "animated-bamboo.about.label-image",
    "animated-bamboo.about.nationwide-heading",
    "animated-bamboo.about.nationwide-text",
    "animated-bamboo.about.cta-heading",
    "animated-bamboo.about.cta-text",
    "animated-bamboo.about.cta-button-link",
    "animated-bamboo.about.cta-button-text",
    "animated-bamboo.about.cta-secondary-button-link",
    "animated-bamboo.about.cta-secondary-button-text",
  ]);

  const valuesList = parseTemplateIconListRows(
    getListFieldValue(customFields, "animated-bamboo.about.values-list"),
    DEFAULT_ANIMATED_BAMBOO_VALUES,
  );
  const whyBambooFacts = parseTemplateIconListRows(
    getListFieldValue(
      customFields,
      "animated-bamboo.about.why-bamboo-facts-list",
    ),
    DEFAULT_ANIMATED_BAMBOO_WHY_BAMBOO_FACTS,
  );
  const nationwideList = parseTemplateIconListRows(
    getListFieldValue(
      customFields,
      "animated-bamboo.about.nationwide-facts-list",
    ),
    DEFAULT_ANIMATED_BAMBOO_NATIONWIDE_FACTS,
  )?.slice(0, 3);
  ...
  const heroImage = f["animated-bamboo.about.hero-image"] ?? "";
  const hasHeroImage = heroImage.trim() !== "";

  const missionImage =
    f["animated-bamboo.about.mission-image"] ?? "/placeholder.svg";
  const hasMissionImage =
    missionImage.trim() !== "" && missionImage !== "/placeholder.svg";

  const labelImage =
    f["animated-bamboo.about.label-image"] ?? "/placeholder.svg";
  ...
  const labelVisible = isSectionVisible(
    customFields,
    "animated-bamboo",
    "about.label",
  );
      ...
      >
        ...
        <div className="relative z-2 mx-auto grid w-[min(1200px,calc(100%-48px))] items-center gap-7 md:grid-cols-2 md:gap-[clamp(28px,4vw,60px)]">
          <div>
            ...
            >
              <span {...fieldAttr("animated-bamboo.about.hero-heading")}>
                {f["animated-bamboo.about.hero-heading"] ?? ""}
              </span>
            </h1>
            <p
              className="mt-5 max-w-[47ch] text-[1.05rem] leading-[1.62] text-[var(--bamboo-ink)]"
              {...fieldAttr("animated-bamboo.about.hero-intro")}
            >
              {f["animated-bamboo.about.hero-intro"] ?? ""}
            </p>
          </div>
        ...
        <div className="mx-auto grid w-[min(1200px,calc(100%-48px))] items-start gap-8 md:grid-cols-[1.1fr_0.9fr] md:gap-[clamp(34px,5vw,76px)]">
          <BambooReveal>
            <h2
              ...
              {...fieldAttr("animated-bamboo.about.mission-heading")}
            >
              {f["animated-bamboo.about.mission-heading"] ?? ""}
            </h2>
            <p
              className="mt-5 max-w-[60ch] whitespace-pre-line text-[var(--bamboo-ink-soft)]"
              {...fieldAttr("animated-bamboo.about.mission-paragraph")}
            >
              {f["animated-bamboo.about.mission-paragraph"] ?? ""}
            </p>
          </BambooReveal>
        ...
        <div className="mx-auto w-[min(1200px,calc(100%-48px))]">
          <BambooReveal className="mx-auto max-w-[690px] text-center">
            ...
            <h2
              ...
              {...fieldAttr("animated-bamboo.about.detroit-heading")}
            >
              {f["animated-bamboo.about.detroit-heading"] ?? ""}
            </h2>
            <p
              className="mx-auto mt-[18px] max-w-[58ch] text-[var(--bamboo-ink-soft)]"
              {...fieldAttr("animated-bamboo.about.detroit-body")}
            >
              {f["animated-bamboo.about.detroit-body"] ?? ""}
            </p>
          </BambooReveal>
        </div>
      </section>
        ...
        <div className="mx-auto grid w-[min(1200px,calc(100%-48px))] items-center gap-10 md:grid-cols-2 md:gap-[clamp(40px,5vw,84px)]">
          <BambooReveal>
            <h2
              ...
              {...fieldAttr("animated-bamboo.about.values-heading")}
            >
              {f["animated-bamboo.about.values-heading"] ?? ""}
            </h2>
          ...
          <div className="mx-auto w-[min(1200px,calc(100%-48px))]">
            <BambooReveal className="mx-auto max-w-[660px] text-center">
              <h2
                ...
                className="font-heading text-[clamp(2rem,3.4vw,2.95rem)] font-bold text-[var(--bamboo-pine)]"
                {...fieldAttr("animated-bamboo.about.why-bamboo-heading")}
              >
                {f["animated-bamboo.about.why-bamboo-heading"] ?? ""}
              </h2>
              <p
                className="mx-auto mt-4 max-w-[56ch] text-[var(--bamboo-ink-soft)]"
                {...fieldAttr("animated-bamboo.about.why-bamboo-intro")}
              >
                {f["animated-bamboo.about.why-bamboo-intro"] ?? ""}
              </p>
            </BambooReveal>
          ...
          <div className="mx-auto w-[min(1200px,calc(100%-48px))]">
            <BambooReveal className="mx-auto max-w-[690px] text-center">
              <h2
                ...
                className="font-heading text-[clamp(1.85rem,3.1vw,2.7rem)] font-bold text-[var(--bamboo-pine)]"
                {...fieldAttr("animated-bamboo.about.supplier-heading")}
              >
                {f["animated-bamboo.about.supplier-heading"] ?? ""}
              </h2>
              <p
                className="mx-auto mt-[18px] max-w-[58ch] whitespace-pre-line text-[var(--bamboo-ink-soft)]"
                {...fieldAttr("animated-bamboo.about.supplier-text")}
              >
                {f["animated-bamboo.about.supplier-text"] ?? ""}
              </p>
            </BambooReveal>
          </div>
        </section>
          ...
          <div className="mx-auto grid w-[min(1200px,calc(100%-48px))] items-center gap-8 md:grid-cols-[.86fr_1.14fr] md:gap-[clamp(32px,4.5vw,72px)]">
            ...
            <BambooReveal style={{ "--rd": "120ms" } as React.CSSProperties}>
              ...
              <h2
                id="bamboo-label-h"
                className="font-heading text-[clamp(1.85rem,3.1vw,2.7rem)] font-bold text-[var(--bamboo-pine)]"
                {...fieldAttr("animated-bamboo.about.label-heading")}
              >
                {f["animated-bamboo.about.label-heading"] ?? ""}
              </h2>
              <p
                className="mt-[18px] max-w-[56ch] text-[var(--bamboo-ink-soft)]"
                {...fieldAttr("animated-bamboo.about.label-body")}
              >
                {f["animated-bamboo.about.label-body"] ?? ""}
              </p>
            </BambooReveal>
          </div>
        </section>
          ...
          <div className="mx-auto w-[min(1200px,calc(100%-48px))]">
            <BambooReveal className="mx-auto max-w-[660px] text-center">
              <h2
                ...
                className="font-heading text-[clamp(2rem,3.4vw,2.95rem)] font-bold text-[var(--bamboo-pine)]"
                {...fieldAttr("animated-bamboo.about.nationwide-heading")}
              >
                {f["animated-bamboo.about.nationwide-heading"] ?? ""}
              </h2>
              <p
                className="mx-auto mt-4 max-w-[56ch] text-[var(--bamboo-ink-soft)]"
                {...fieldAttr("animated-bamboo.about.nationwide-text")}
              >
                {f["animated-bamboo.about.nationwide-text"] ?? ""}
              </p>
            </BambooReveal>
        ...
        >
          <BambooReveal className="mx-auto w-[min(600px,calc(100%-48px))]">
            ...
            <h2
              ...
              className="font-heading text-[clamp(1.85rem,3.1vw,2.7rem)] font-bold text-[var(--bamboo-pine)]"
              {...fieldAttr("animated-bamboo.about.cta-heading")}
            >
              {f["animated-bamboo.about.cta-heading"] ?? ""}
            </h2>
            <p
              className="mx-auto mt-4 max-w-[52ch] text-[var(--bamboo-ink-soft)]"
              {...fieldAttr("animated-bamboo.about.cta-text")}
            >
              {f["animated-bamboo.about.cta-text"] ?? ""}
            </p>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3.5">
              <Link
                href={f["animated-bamboo.about.cta-button-link"] ?? "/shop"}
                className="bamboo-btn bamboo-btn-primary"
              >
                <span {...fieldAttr("animated-bamboo.about.cta-button-text")}>
                  {f["animated-bamboo.about.cta-button-text"] ?? ""}
                </span>
              </Link>
              <Link
                href={
                  f["animated-bamboo.about.cta-secondary-button-link"] ??
                  "/contact"
                }
              ...
              >
                ...
                >
                  {f["animated-bamboo.about.cta-secondary-button-text"] ?? ""}
                </span>
              </Link>
            </div>
          </BambooReveal>
