...
const blogPageData: TemplateField[] = [
  {
    key: "animated-bamboo.blog.listing-title",
  ...
  {
    key: "animated-bamboo.blog.listing-intro",
  ...
  {
    key: "animated-bamboo.blog.listing-image",
  ...
  {
    key: "animated-bamboo.blog.post-cta-heading",
  ...
  {
    key: "animated-bamboo.blog.post-cta-body",
  ...
  {
    key: "animated-bamboo.blog.post-cta-button-text",
  ...
  {
    key: "animated-bamboo.blog.post-cta-button-link",
