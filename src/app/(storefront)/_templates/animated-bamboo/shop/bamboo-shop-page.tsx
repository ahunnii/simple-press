...
export async function BambooShopPage({
  ...
  const f = resolveFields(customFields, [
    "animated-bamboo.products.listing-title",
    "animated-bamboo.products.listing-intro",
  ]);
  const benefits =
    parseTemplateTrustBadgesListRows(
      getListFieldValue(
