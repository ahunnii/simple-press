...
const productsPageData: TemplateField[] = [
  {
    key: "animated-bamboo.products.listing-title",
  ...
  {
    key: "animated-bamboo.products.listing-intro",
  ...
  {
    key: "animated-bamboo.products.why-strip-list",
  ...
  {
    key: "animated-bamboo.products.reassurance-heading",
  ...
  {
    key: "animated-bamboo.products.reassurance-body",
  ...
  {
    key: "animated-bamboo.products.reassurance-button-text",
  ...
  {
    key: "animated-bamboo.products.reassurance-button-link",
 ...
 * owner hasn't customized `animated-bamboo.products.why-strip-list`. */
