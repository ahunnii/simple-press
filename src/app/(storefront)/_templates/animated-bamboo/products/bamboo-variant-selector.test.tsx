...
type FakeProduct = Parameters<typeof BambooVariantSelector>[0]["product"];
...
describe("BambooVariantSelector (animated-bamboo)", () => {
  it("reports the shopper's chosen quantity to the parent via onQuantityChange", async () => {
