...
export function BambooProductPage({
  ...
  const f = resolveFields(customFields, [
    "animated-bamboo.products.reassurance-heading",
    "animated-bamboo.products.reassurance-body",
    "animated-bamboo.products.reassurance-button-text",
    "animated-bamboo.products.reassurance-button-link",
  ]);
  ...
  const benefits: { label: string }[] =
    displayTrustBadges.length > 0
      ...
      : (parseTemplateTrustBadgesListRows(
          getListFieldValue(
            customFields,
            "animated-bamboo.products.why-strip-list",
          ),
      ...
      >
        ...
        <div className="relative z-1 mx-auto grid w-[min(1200px,calc(100%-48px))] grid-cols-1 items-center gap-[clamp(32px,4.4vw,68px)] lg:grid-cols-2">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2
                ...
                {...fieldAttr("animated-bamboo.products.reassurance-heading")}
                className="font-heading text-[1.5rem] leading-[1.15] font-bold tracking-[-0.01em] text-[var(--bamboo-pine)]"
              >
                {f["animated-bamboo.products.reassurance-heading"] ?? ""}
              </h2>
              <p
                {...fieldAttr("animated-bamboo.products.reassurance-body")}
                className="mt-2 max-w-[42ch] text-[var(--bamboo-ink)]"
              >
                {f["animated-bamboo.products.reassurance-body"] ?? ""}
              </p>
            </div>
          </div>
          <div className="flex flex-wrap gap-3.5 lg:justify-end">
            ...
            <Link
              href={
                f["animated-bamboo.products.reassurance-button-link"] ??
                "/contact"
              }
            ...
            >
              ...
              >
                {f["animated-bamboo.products.reassurance-button-text"] ?? ""}
              </span>
            </Link>
          </div>
        </div>
