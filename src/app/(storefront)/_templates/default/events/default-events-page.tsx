                ...
                return (
                  ...
                  >
                    {/* Flier — one media slot per event, video first. Both
                        media types letterbox inside the framed 3:4 box on the
                        #efece8 background; a video now expands into a lightbox
                        with native controls, an image opens full size. */}
