...
function Toc({
  ...
  return (
    <nav
      ...
      className="hidden lg:block sticky top-[calc(72px+32px)] self-start"
    >
      <p className="mb-4 text-[11px] font-medium tracking-[0.14em] uppercase text-[#6b6b6b]">
        On this page
      </p>
        ...
        {headings.map((h) => (
          <li key={h.id}>
            <a
              href={`#${h.id}`}
              className={cn(
                "block border-l-[2px] -ml-px py-0.5 text-[13px] transition-colors",
                h.level === 3 ? "pl-5" : "pl-3",
                activeId === h.id
        ...
        <div className="mx-auto max-w-[1440px]">
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-[200px_1fr]">
            ...
            <div className="min-w-0">
              <p className="mb-8 text-[12px] font-medium tracking-[0.1em] uppercase text-[#a3a3a3]">
