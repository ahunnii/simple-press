    ...
    <div className="wealth-account">
      ...
      <section
        ...
        style={{
          maxWidth: "var(--wealth-container)",
          padding:
            "calc(var(--wealth-rhythm) * 1.5) var(--wealth-gutter) calc(var(--wealth-rhythm) * 2)",
        }}
      >
        ...
        <nav aria-label="Account navigation" className="mb-8 md:hidden">
          <ul
            role="list"
            className="flex list-none gap-1.5 overflow-x-auto p-0 pb-2"
          >
