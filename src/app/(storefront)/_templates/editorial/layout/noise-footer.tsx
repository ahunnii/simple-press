...
export async function NoiseFooter({ business }: DefaultFooterTemplateProps) {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-9 px-7 pt-16 pb-10 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
        ...
        <div className="flex flex-col gap-0">
          ...
          <div
            className="mb-4 font-serif leading-[1] italic select-none"
          ...
          >
            ...
            {!address && !phone && !email && <span>Detroit, Michigan</span>}
          </div>
        ...
        <div>
          <h4
            className="mb-4 font-mono text-[10.5px] tracking-[0.22em] uppercase"
            style={{ color: "var(--vn-steel-mist)" }}
          >
            Shop
          </h4>
          ...
          <ul className="flex flex-col gap-2">
            {socialLinks?.instagram && (
              <li>
                <a
                  href={socialLinks.instagram}
                  className="block font-sans text-sm transition-opacity hover:opacity-60"
                  style={{ color: "var(--vn-bone)" }}
                >
                  Instagram /&nbsp;
      ...
      >
        ...
        <span
          ...
          style={{ color: "var(--vn-steel-mist)" }}
        >
          &copy; {new Date().getFullYear()} {name} — Detroit. All garments
          numbered.
        </span>

        {/* Slogan — center, hidden on small screens */}
        <span
          className="hidden font-mono text-[10px] tracking-[0.18em] uppercase lg:block"
          style={{ color: "var(--vn-steel-mist)" }}
        >
