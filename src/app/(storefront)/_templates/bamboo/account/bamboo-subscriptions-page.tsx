...
import { bambooSubscriptionStatusClass } from "../shared/bamboo-status";
...
export function BambooSubscriptionsPage({
  subscriptions,
                    ...
                    <CardContent className="p-6">
                      <div className="flex flex-wrap items-start justify-between gap-4">
                        ...
                        <div className="flex flex-col items-end gap-2">
                          <span
                            className={`rounded-full px-3 py-1 text-xs font-medium capitalize ${bambooSubscriptionStatusClass(subscription.status)}`}
                          >
