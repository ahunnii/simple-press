    ...
    <div className="min-h-screen">
      <section className="bg-secondary/30 py-16">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          <span className="text-primary mb-3 block text-sm tracking-[0.3em] uppercase">
            Kind words
          </span>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        {testimonials.length === 0 ? (
          ...
          <>
            ...
            <div className="bg-secondary/30 mt-12 rounded-3xl px-8 py-12 text-center">
              ...
              <Link
                ...
                className="bg-primary text-primary-foreground mt-6 inline-block rounded-full px-6 py-3 text-sm font-medium tracking-wide transition-opacity hover:opacity-90"
              >
                Write a Testimonial
              </Link>
            </div>
