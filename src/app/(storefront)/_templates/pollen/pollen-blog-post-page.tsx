        ...
        <section className="bg-background pb-16">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <TiptapRenderer
              ...
              className="prose prose-lg max-w-none prose-headings:text-[#374151] prose-p:text-[#4b5563] prose-a:text-[#1f1f1f] prose-a:no-underline hover:prose-a:text-green-600 prose-strong:text-[#374151] prose-code:text-green-400 prose-pre:border prose-pre:border-black/20 prose-pre:bg-zinc-900/50"
            />
