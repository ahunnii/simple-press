...
export const pinkTableFields: TemplateField[] = [
  // ── pink-table.hero ────────────────────────────────────────────────────
  {
    ...
    label: "Duration",
    description:
      "Shown in the hero eyebrow alongside the group size, e.g. '90 minutes'.",
    type: "text",
    page: "homepage",
  ...
  // ── pink-table.timeline (hideable — blank list) ─────────────────────────
  {
    ...
    gridColumn: "col-span-full",
    defaultValue: "How the hour runs",
  ...
  // ── pink-table.sidebar ───────────────────────────────────────────────────
  {
    ...
    label: "Price Panel Label",
    type: "text",
    page: "homepage",
    group: "pink-table.sidebar",
    gridColumn: "col-span-1",
    defaultValue: "Starting at",
    description: "Small uppercase label above the price in the sidebar.",
  },
  {
    ...
    group: "pink-table.sidebar",
    gridColumn: "col-span-1",
    defaultValue: "Per group · materials included",
    description: "Muted line under the price.",
  },
  {
    key: "pink-table.price-cta-label",
    label: "Price Panel Button Text",
    type: "text",
    page: "homepage",
    group: "pink-table.sidebar",
    gridColumn: "col-span-1",
    defaultValue: "Request this date",
...
const pinkTableFieldGroups: TemplateFieldGroup[] = [
  ...
  },
  {
    ...
    title: "Sidebar Price Panel",
    description: "Labels for the sticky price panel and quick links",
    icon: "🏷️",
    columns: 2,
  },
  {
...
export const pinkServiceTemplateDefs: ServiceTemplateDef[] = [
  {
    ...
    description:
      "PinkArt service detail layout: photographic hero with fact rows, a project picker built from your ServiceItems, an optional timeline / brings-provides / gallery / pull-quote / FAQ, and a sticky price + request panel.",
