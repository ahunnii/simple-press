      ...
      expect(
        isInStock(
          makeProduct({
            ...
            allowBackorders: false,
            variants: [
              { id: "v1", name: "V1", price: null, compareAtPrice: null, inventoryQty: 0 },
              { id: "v2", name: "V2", price: null, compareAtPrice: null, inventoryQty: 3 },
            ],
          }),
        ),
      ).toBe(true);
      ...
      expect(
        isInStock(
          makeProduct({
            ...
            variants: [
              { id: "v1", name: "V1", price: null, compareAtPrice: null, inventoryQty: 0 },
              { id: "v2", name: "V2", price: null, compareAtPrice: null, inventoryQty: 0 },
            ],
          }),
        ),
      ).toBe(false);
